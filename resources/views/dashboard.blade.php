    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up" style="color: black; margin-top: -150px;">
            <span class="d-none d-lg-block" style="color: black">
              <img src="assets/img/logo.png" alt="" style="width: 40px; margin-top: -10px;"> Kishan Ambani
            </span> Welcome
          </h1>
          <img src="assets/img/hero-services-img.webp" class="img-fluid hero-img" alt="" data-aos="zoom-out" data-aos-delay="300" style="width: 500px;">
        </div>
      </div>
    </section>
  </main>
